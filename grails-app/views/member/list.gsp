			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="secretId" title="${message(code: 'member.secretId.label', default: 'Secret Id')}" />
				...
				<g:each in="${memberInstanceList}" status="i" var="memberInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${memberInstance.id}">${fieldValue(bean: memberInstance, field: "secretId")}</g:link></td>
