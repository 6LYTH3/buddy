	...
	<body>
		...
		<div id="show-member" class="content scaffold-show" role="main">
			...
			<ol class="property-list member">
				...
				<g:if test="${memberInstance?.secretId}">
				<li class="fieldcontain">
					<span id="secretId-label" class="property-label"><g:message code="member.secretId.label" default="Secret Id" /></span>
					
						<span class="property-value" aria-labelledby="secretId-label"><g:fieldValue bean="${memberInstance}" field="secretId"/></span>
